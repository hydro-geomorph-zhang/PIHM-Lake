...
//	zmin_cor = (double *) malloc(DS->NumEle * sizeof(double));
	...
	DS->Gate_height = (double *)malloc((DS->NumLake)*sizeof(double));
	DS->Orifice_flow = (double **)malloc((DS->NumEle)*sizeof(double));
	DS->Spill_flow = (double **)malloc((DS->NumEle)*sizeof(double));
	...
	for (i = 0; i < DS->NumEle; i++) 
	{
		...
		DS->Orifice_flow[i] = (double *) malloc(3 * sizeof(double));
        DS->Spill_flow[i] = (double *) malloc(3 * sizeof(double));
